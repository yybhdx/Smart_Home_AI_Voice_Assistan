...
基于 ESP32-S3 双核单片机的智能家居系统，融合了小智 AI 语音交互与传感器数据采集上传功能。
...
```
STM32F103                          ESP32-S3                           华为云
┌─────────┐                     ┌──────────────────┐              ┌──────────┐
│ 传感器   │                     │                  │              │          │
│ 采集    │──UART3(PB10)────→  │ UART1(GPIO9)     │              │          │
│(每1秒)  │   JSON数据          │      ↓           │              │  IoT     │
│         │                     │ stm32_task 读取   │              │  Device  │
│ OLED    │                     │      ↓           │              │  Hub     │
│ 显示    │                     │ MQTT 发布(每1秒)  │──MQTT(1883)─→│          │
│ 蜂鸣器  │                     │                  │   传感器数据  │          │
│ 报警    │                     │  ─ ─ ─ ─ ─ ─ ─  │              │          │
│         │                     │                  │              │          │
│         │                     │ 小智 AI 语音交互  │              │          │
